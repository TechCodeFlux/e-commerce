...
class OptionValueController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $optionValues = OptionValue::query()
                ...
                return DataTables::of($optionValues)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    // Edit
                    $actions .= '
                        <a href="' . route('admin.option_value_management.edit_option_value', $row->id) . '" 
                    ...
                    // Delete
                     $actions .= '<button 
                                 ...
                                 onclick="deleteOptionValue(' . $row->id . ')"
                                 title="Delete">
    ...
    public function create()
    {
        ...
        $option_list = Option::where('status', 1)
        ->orderBy('name')
        ->get();
        return view('admin.option_value_management.add_option_value', compact('option_value','option_list'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('admin.option_value_management.show_option_value')
     ...
     */
    public function edit_option_value($id)
    {
        $admin = Auth::guard('admin')->user();

         $option_value = OptionValue::where('id', $id)
        ->firstOrFail();
         $option_list = Option::orderBy('name')->get(); 
          return view('admin.option_value_management.add_option_value',compact('option_value','option_list'));
    }
