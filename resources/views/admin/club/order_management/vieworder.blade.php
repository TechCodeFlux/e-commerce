    ...
    <div class="mb-4">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-building small me-2"></i>Order's</li>
            </ol>
        </nav>
    </div>
                    ...
                    <div class="modal fade" id="delete-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
                        ...
                        $(document).ready(function() {
                            $orderTable = $('#order').DataTable({
                                ...
                                dom: 'rtip',
                                ajax: {
                                    url: "{{ route('admin.club.vieworder', $club->id) }}",
                                    data: function(d) {}
                                },
                                columns: [
                                    { 
                                        ...
                                        render: function(data, type, row) {
                                            ...
                                            const stockText = Number(row.stock) > 0 ? ' ' : ' ';
                                            ...
                                            <div class="card-body py-3">
                                                <div class="row align-items-center text-center text-md-start g-3">
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <h4 class="fw-bold text-dark mb-2">${row.name}</h4>
